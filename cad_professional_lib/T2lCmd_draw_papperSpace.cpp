...
//===================================================================
Cmd_draw_papperSpace::Cmd_draw_papperSpace(void) :
    CmdCad( "draw papper" )
{
}
...
//===================================================================
void Cmd_draw_papperSpace::enterPoint( const T2l::Point2F& pt, Display& view )
{
    UpdateLock l;
    ...
    new CadObject_papperSpace( pt, CAD_SETTINGS.papperFactor(), CAD_SETTINGS.drawingUnitInMm(),
                          CAD_SETTINGS.papperWidthInMm(), CAD_SETTINGS.papperHeightInMm(),
                          ActiveFile::activeGet()->file());
    registerFileChange();

    QStringList files = CAD_SETTINGS.printFiles().split("|");
    for (QString file : files) ps->appendTarget(file);
...
//===================================================================
void Cmd_draw_papperSpace::enterMove( const T2l::Point2F& pt, Display& view )
{
    ...
    EntityList list;
    CadObject_papperSpace papper( pt, CAD_SETTINGS.papperFactor(), CAD_SETTINGS.drawingUnitInMm(),
...
//===================================================================
QString Cmd_draw_papperSpace::dialog() const {
    QString result;
...
//===================================================================
QString Cmd_draw_papperSpace::dialogTml() const
{
    QString result;
    ...
    result += "TC;control: text;";
    result += "text: 1:1;";
    result += "cmd: cad_set_papper_factor 1;";
    result += "width: 40;;";
    result += "TC;CT;text: <space>;;";
    ...
    result += "TC;CT;text: <hup>;;";
    result += "TC;control: text;";
    result += "text: print files:;;";
    result += "TC;CT;text: <space>;;";
    result += "TC;control: spacer;spacer: minx;value: 135;;";
    result += "TC;control: edit;";
    result += "text: " + CAD_SETTINGS.printFiles() + ";";
    result += "cmd: cad_set_print_files \"$TEXT\";";
    result += "width: 600;;";
